...
### Fixed
- Removed legacy root Next.js/React dependencies that caused mixed React versions in the Vite frontend bundle.
- Simplified React Router layout structure to use a standard shell route with `Outlet`.
- Reduced root dependency surface for faster, cleaner Vercel frontend builds.

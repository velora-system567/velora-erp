/**
 * Check PRODUCTION behavior: login, open /sales directly, capture exact error.
 */
import { chromium } from "playwright";

const BASE = "https://velora-erp.vercel.app";
const USER = process.env.PUSER || "jishan@velora.com";
const PASS = process.env.PPASS || "Velora@123";
...
(async () => {
  ...
  if (await summary.count()) {
    ...
    console.log((await page.locator("details pre").first().innerText().catch(() => "n/a")).slice(0, 3000));
  }
